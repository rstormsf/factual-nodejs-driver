  ...
  getCallback: function (req) {
    ...
    return function (error, data, response) {
      ...
      if (error) {
        ...
        return cb({from: 'request', error: error}, null);
      }
      ...
      if (isDebug) {
        ...
        debugInfo.response.header = response.header;
      ...
      try {
        ...
        return cb({from: 'response', error: err}, null);
      }
      ...
      if (res.status != "ok") {
        ...
        if (isDebug) console.log('debug:', debugInfo);
        cb({from: 'factual', error: res}, null);
      } else {
        if (isDebug) console.log('debug:', debugInfo);
